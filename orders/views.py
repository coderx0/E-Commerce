...
def payments(request):
    ...
    order.save()
    #move the cart items yo order_product table 
    ...
    #send order recieved  to customer via email
    ...
    send_email.send()
    #send order_number and transaction_id to sendDate method
    data = {
...
def order_complete(request):
    ...
    try:
        ...
        for i in ordered_products:
            subTottal+=i.product_price*i.quantity
